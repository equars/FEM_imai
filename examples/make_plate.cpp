...
int main(int argc, char* argv[]){
    ...
    cout<<"koko\n";
    for (int i = 0; i < 4; i++) {
        b=57+3*i ; c=61+3*i; d=60+3*i;
        cout << count << "  " << b << "  " << c << "  " << d << "\n" ;
        count++ ;
        b=57+3*i ; c=58+3*i; d=61+3*i;
        cout << count << "  " << b << "  " << c << "  " << d << "\n" ;
        count++ ;
        b=61+3*i ; c=58+3*i; d=59+3*i;
        cout << count << "  " << b << "  " << c << "  " << d << "\n" ;
        count++ ;
        b=62+3*i ; c=61+3*i; d=59+3*i;
        cout << count << "  " << b << "  " << c << "  " << d << "\n" ;
        count++ ;
    }
    cout<<"owa\n";
    ...
    for (int i = 1; i < 5; i++) {
        b=59+i*3 ; c=56+i*3; d=85+i*4;
        cout << count << "  " << b << "  " << c << "  " << d << "\n" ;
        count++ ;
        b=85+i*4 ; c=56+i*3; d=81+i*4;
        cout << count << "  " << b << "  " << c << "  " << d << "\n" ;
        count++ ;
    }
